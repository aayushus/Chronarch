...
export default function AccountSettings() {
  ...
  return (
    <div>
      ...
      {/* Appearance */}
      <div style={{ background: "var(--bg-raised)", border: "1px solid var(--border-subtle)", borderRadius: "var(--radius-xl)", padding: 20, marginBottom: 16 }}>
        <div style={{ fontSize: "var(--text-md)", fontWeight: 600, marginBottom: 4 }}>Appearance</div>
        ...
        <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
          <div style={{ flex: "1 1 180px" }}>
            <div style={{ fontSize: "var(--text-sm)", fontWeight: 600, color: "var(--text-secondary)", marginBottom: 6, textTransform: "uppercase", letterSpacing: "0.04em" }}>
              Theme
            </div>
            <select className="input-standard select" value={theme} onChange={(e) => setTheme(e.target.value as "dark" | "light")}  style={{ width: "100%" }}>
          ...
          <div style={{ flex: "1 1 180px" }}>
            ...
            <select className="input-standard select" value={calendarRowMinutes} onChange={(e) => setCalendarRowMinutes(Number(e.target.value) as 30 | 60)}  style={{ width: "100%" }}>
          ...
          <div style={{ flex: "1 1 180px" }}>
            ...
            <select className="input-standard select" value={density} onChange={(e) => setDensity(e.target.value as "comfortable" | "compact")}  style={{ width: "100%" }}>
      ...
      {/* Profile */}
      <div style={{ background: "var(--bg-raised)", border: "1px solid var(--border-subtle)", borderRadius: "var(--radius-xl)", padding: 20, marginBottom: 16 }}>
        <div style={{ fontSize: "var(--text-md)", fontWeight: 600, marginBottom: 4 }}>Profile</div>
        <div style={{ fontSize: "var(--text-sm)", color: "var(--text-secondary)", marginBottom: 14 }}>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          <div style={{ flex: "1 1 200px" }}>
            <label style={{ display: "block", fontSize: "var(--text-sm)", fontWeight: 600, color: "var(--text-secondary)", marginBottom: 4 }}>
              Display name
            </label>
            <input
              type="text"
          ...
          <div style={{ flex: "1 1 200px" }}>
            ...
            <select className="input-standard select" value={timezone} onChange={(e) => setTimezone(e.target.value)}  style={{ width: "100%" }}>
        ...
        <button onClick={handleSaveProfile} disabled={saving} className="btn-primary hoverable" style={{ padding: "7px 16px", fontSize: "var(--text-sm)", marginTop: 12 }}>
      ...
      <div style={{ background: "var(--bg-raised)", border: "1px solid var(--border-subtle)", borderRadius: "var(--radius-xl)", padding: 20, marginBottom: 16 }}>
        <div style={{ fontSize: "var(--text-md)", fontWeight: 600, marginBottom: 4 }}>Scheduling preferences</div>
        <div style={{ fontSize: "var(--text-sm)", color: "var(--text-secondary)", marginBottom: 14 }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  color: on ? "var(--text-on-fill)" : "var(--text-secondary)",
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          <div style={{ flex: "1 1 140px" }}>
            ...
            <input className="input-standard input-native" type="time" value={whStart} onChange={(e) => setWhStart(e.target.value)}  style={{ width: "100%" }} />
          </div>
          <div style={{ flex: "1 1 140px" }}>
            <label style={{ display: "block", fontSize: "var(--text-sm)", fontWeight: 600, color: "var(--text-secondary)", marginBottom: 4 }}>
              Day ends
            </label>
            <input className="input-standard input-native" type="time" value={whEnd} onChange={(e) => setWhEnd(e.target.value)}  style={{ width: "100%" }} />
          </div>
          <div style={{ flex: "1 1 140px" }}>
            <label style={{ display: "block", fontSize: "var(--text-sm)", fontWeight: 600, color: "var(--text-secondary)", marginBottom: 4 }}>
              Min. notice (min)
        ...
        <button onClick={handleSavePrefs} disabled={savingPrefs} className="btn-primary hoverable" style={{ padding: "7px 16px", fontSize: "var(--text-sm)", marginTop: 12 }}>
          {savingPrefs ? "Saving…" : "Save preferences"}
        </button>
        {prefsSaved && (
          <span style={{ fontSize: "var(--text-sm)", color: "var(--success)", marginLeft: 10 }}>Saved.</span>
        )}
      </div>

      {/* Sign out */}
      <div style={{ background: "var(--bg-raised)", border: "1px solid var(--border-subtle)", borderRadius: "var(--radius-xl)", padding: 20 }}>
        <div style={{ fontSize: "var(--text-md)", fontWeight: 600, marginBottom: 4 }}>Session</div>
        ...
        <button onClick={handleSignOut} className="btn-danger hoverable" style={{ padding: "7px 16px", fontSize: "var(--text-sm)" }}>
          Sign out
        </button>
      </div>
    </div>
