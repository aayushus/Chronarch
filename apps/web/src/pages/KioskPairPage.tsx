...
export default function KioskPairPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#111113", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ textAlign: "center", maxWidth: 480 }}>
        <div style={{ fontSize: 13, color: "#98989d", marginBottom: 12 }}>Pair this display</div>
        {error && !code ? (
          <div style={{ fontSize: 15, color: "#ff453a" }}>{error}</div>
        ) : !code ? (
          <>
            ...
            <input
              ...
              style={{ background: "#1e1e21", border: "1px solid #3a3a3c", borderRadius: 8, color: "#f5f5f7", padding: "10px 16px", fontSize: 14, width: 260, textAlign: "center", marginBottom: 12 }}
            />
            <div>
            ...
            {error && <div style={{ fontSize: 13, color: "#ff453a", marginTop: 10 }}>{error}</div>}
          </>
        ) : (
          <>
            ...
            <div style={{ fontSize: 64, fontWeight: 800, letterSpacing: "0.12em", color: "#f5f5f7" }}>
              {code.slice(0, 3)} {code.slice(3)}
            </div>
            <div style={{ fontSize: 12, color: "#636366", marginTop: 12 }}>Waiting for approval…</div>
          </>
        )}
      </div>
    </div>
