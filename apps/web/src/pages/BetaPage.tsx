...
import { dayStats, formatMinutes, greeting } from "../lib/beta";
import { pickCountdowns } from "../lib/kiosk";
import { fetchEventsLazy, invalidateEventsCache } from "../lib/eventsCache";
import type { CalendarViewMode } from "../components/TopBar";
...
/** Beta command center (/beta): greeting header, focus rails, same engine. */
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", background: "var(--bg-app)", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, display: "flex", minHeight: 0, minWidth: 0 }}>
        {/* Focus rail */}
        {showRails && (
          <aside style={{ width: 280, minWidth: 280, borderRight: "1px solid var(--border-subtle)", overflowY: "auto", padding: "16px 14px", display: "flex", flexDirection: "column", gap: 16 }}>
            <MiniMonth
            ...
            />
            <section style={{ background: "var(--bg-raised)", border: "1px solid var(--border-subtle)", borderRadius: "var(--radius-md)", padding: "12px 14px" }}>
            ...
            <section>
              <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--text-tertiary)", padding: "0 4px 6px" }}>
                Calendars
              </div>
              {calendars.map((cal) => (
